...
class App extends Component {
  ...
  componentWillMount(){
    ...
    .then(res => {
      console.log("Recieving Getpath data");
      console.log(res.data);
      this.setState({decodePath: res.data}) 
    });
  }
  ...
  render() {
    ...
    let polyLine = (<Polyline path={this.state.decodePath}/>)
    ...
    if (!this.props.loaded && decodePath == null) {
      return (
